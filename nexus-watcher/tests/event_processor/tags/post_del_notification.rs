...
async fn test_homeserver_untag_post_notification() -> Result<()> {
    ...
    let author_user = PubkyAppUser::new("Watcher:UntagPostNotification:Author".to_string(), Some("test_homeserver_untag_post_notification".to_string()), None, None, None);
    ...
    let tagger_user = PubkyAppUser::new("Watcher:UntagPostNotification:Tagger".to_string(), Some("test_homeserver_untag_post_notification".to_string()), None, None, None);
