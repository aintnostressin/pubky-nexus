...
async fn test_edit_tagged_collection_notification() -> Result<()> {
    ...
    let user_a = PubkyAppUser::new("Watcher:CollectionEditNotification:UserA".to_string(), Some("User A bio".to_string()), None, None, None);
    ...
    let user_b = PubkyAppUser::new("Watcher:CollectionEditNotification:UserB".to_string(), Some("User B bio".to_string()), None, None, None);
