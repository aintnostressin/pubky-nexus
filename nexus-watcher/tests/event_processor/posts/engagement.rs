...
async fn test_homeserver_post_engagement() -> Result<()> {
    ...
    let alice = PubkyAppUser::new("Watcher:PostEngagement:Alice".to_string(), Some("test_homeserver_post_engagement".to_string()), None, None, None);
    ...
    let bob_user = PubkyAppUser::new("Watcher:PostEngagement:Bob".to_string(), Some("test_homeserver_post_engagement".to_string()), None, None, None);
...
async fn test_post_counts_read_does_not_seed_engagement() -> Result<()> {
    ...
    let user = PubkyAppUser::new("Watcher:CountsReadEngagement".to_string(), None, None, None, None);
